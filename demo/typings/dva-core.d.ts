declare module 'dva-core' {
  import {Reducer, AnyAction, ReducersMapObject, Dispatch, MiddlewareAPI, StoreEnhancer, Middleware} from 'redux';
   ...
   * @param createOpts
   */
  export function create(opts?: CoreOption, createOpts?: CreateOpts): DvaInstance;
